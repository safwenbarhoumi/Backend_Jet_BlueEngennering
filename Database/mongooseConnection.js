 ...
 const connectToMongoDB = async () => {
  ...
  while (currentRetry < maxRetries) {
    try {
      ...
      console.error(`Error in MongoDB connection (Retry ${currentRetry + 1}/${maxRetries}):`, error);
  ...
  console.error(`Failed to connect to MongoDB after ${maxRetries} retries. Exiting...`);
